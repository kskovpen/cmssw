...
#        pfppointsPFpphiprel = ExtVar(cms.InputTag("electronPNetScores:ElectronpfppointsPFpphiprel"), float, doc="test var"),
#        pfpfeaturesPFpphiprel = ExtVar(cms.InputTag("electronPNetScores:ElectronpfpfeaturesPFpphiprel"), float, doc="test var"),
    ),
)
